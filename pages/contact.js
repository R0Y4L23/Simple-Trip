      ...
      <div className="third">
        ...
        <div className='h-screen'>
          ...
          <div className='h-[60%] flex flex-col items-center justify-center xs:mt-36 mt-20 xs:scale-100 xsss:scale-[0.8] scale-[0.6]'>
            ...
            <div onClick={() => { router.push("/map") }} className="relative z-10 flex flex-row justify-between items-center mx-auto h-[60px] w-[250px] p-10 bg-[#7b5734] bg-opacity-[60%] cursor-pointer hover:bg-opacity-90 duration-1000" target="_blank" rel="noreferrer">

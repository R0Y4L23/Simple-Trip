...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="home">
        <Spline scene="https://prod.spline.design/gBpbD31KD-9HFyDm/scene.splinecode" className='back3d1'/>
        ...
        <div className='sm:w-[80%] h-[75%] flex flex-row justify-between items-center mx-auto xs:scale-100 xss:scale-[0.8] xsss:scale-[0.7] scale-[0.6] sm:ml-20 xss:ml-0 -ml-12'>
          ...
          <div className='flex flex-col'>
            <h1 className="text-[#191730] uppercase tracking-[10px] text-[12px] mt-20 sm:w-4/5 sm:mx-auto sm:text-left text-center pl-2 relative z-10">Find The Best Travel Packages</h1>
            <div className="mt-10 sm:w-4/5 mx-auto flex flex-row xss:justify-between justify-center">
              <div className="flex flex-col justify-center items-start xss:m-0 mx-5">
                  ...
                  <a href="https://forms.gle/Ymk8xtx48jrkPAYDA" target="_blank" rel="noreferrer" className=" relative z-10 flex flex-row justify-between items-center h-[60px] w-[300px] p-10 mt-10 bg-[#7b5734] bg-opacity-[60%] cursor-pointer hover:bg-opacity-90 duration-1000 xs:scale-100 scale-[0.8] xs:-ml-0 -ml-10">
